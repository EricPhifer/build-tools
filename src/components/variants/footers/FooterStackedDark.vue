...
const defaultColumns = [
  { title: 'Services', links: ['Web Design', 'Development', 'SEO', 'Hosting'] },
  ...
  <footer class="bg-gray-900 text-gray-300">
    <div class="max-w-6xl mx-auto px-6 py-12">
      <div class="grid md:grid-cols-3 gap-10 mb-10">
        ...
        <div>
          <h2 class="text-xl font-bold text-white mb-3">{{ siteName || 'Your Brand' }}</h2>
          ...
          <address v-if="businessContact && (businessContact.streetAddress || businessContact.phone || businessContact.city)"
            class="not-italic text-sm text-gray-400 mb-6 leading-relaxed space-y-0.5">
      ...
      <div class="border-t border-gray-800 pt-6 flex flex-wrap justify-between gap-2">
